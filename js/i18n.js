...
(function () {
  ...
  var T = {
    en: {
      ...
      'spa.expect.nourish.title': 'Care', 'spa.expect.nourish.copy': 'Intensive care steps tailored to your scalp and hair.',
    ...
    vi: {
      ...
      'spa.expect.title': 'Chăm sóc theo nhu cầu, từ da đầu đến mái tóc',
      ...
      'spa.expect.nourish.copy': 'Bổ sung các bước chăm sóc chuyên sâu dành cho da đầu, mái tóc.',
    ...
    zh: {
      ...
      'spa.expect.nourish.title': '护理', 'spa.expect.nourish.copy': '为头皮和秀发加入深层护理步骤。',
