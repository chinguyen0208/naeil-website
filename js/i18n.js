...
(function () {
  ...
  var T = {
    en: {
      ...
      'spa.services.scalpreset.subdesc': 'Scalp Polish · Deep Scalp Cleansing',
      ...
      'spa.services.hairreplenish.subdesc': 'Hair Treatment · Intensive Nourishment',
    ...
    vi: {
      ...
      'home.hero.title': 'Đẹp hơn, theo cách của riêng bạn',
      'home.hero.sub': 'Có những ngày, chỉ cần chậm lại một chút để yêu chiều bản thân.',
      ...
      'home.services.lash.title': 'Lash Lift',
      'home.services.lash.copy': 'Dịch vụ uốn mi tôn lên vẻ đẹp tự nhiên của hàng mi với độ cong mềm mại, mang đến ánh nhìn tươi tắn và chỉn chu mỗi ngày.',
      'home.services.lash.link': 'Tìm hiểu thêm',
      'home.services.spa.title': 'Head Spa',
      'home.services.spa.copy': 'Dịch vụ gội đầu thư giãn giúp chăm sóc da đầu, xoa dịu căng thẳng và mang đến cảm giác thư thái với những kỹ thuật massage chuyên nghiệp.',
      ...
      'spa.hero.title': 'Head Spa',
      'spa.hero.sub': 'Chăm sóc da đầu chuyên sâu, thư giãn trọn vẹn.',
      'spa.hero.desc': 'Dịch vụ gội đầu thư giãn giúp làm sạch, nuôi dưỡng và cân bằng da đầu. Kết hợp các kỹ thuật massage chuyên sâu để xoa dịu căng thẳng, cải thiện tuần hoàn và nuôi dưỡng mái tóc khỏe mạnh, óng mượt từ gốc.',
      'spa.hero.cta': 'Đặt lịch dịch vụ',
      'spa.services.eyebrow': 'Các dịch vụ gội đầu thư giãn',
      'spa.services.sub': 'Mỗi liệu trình được chăm chút kỹ lưỡng, phù hợp với nhu cầu riêng của khách hàng.',
      'spa.services.essential.title': 'Cơ bản - 45 PHÚT',
      'spa.services.essential.subdesc': 'Gội nhanh · Làm sạch cơ bản',
      'spa.services.essential.copy': 'Liệu trình làm sạch nhẹ nhàng, phù hợp cho việc chăm sóc da đầu hằng ngày. Gồm gội đầu, massage da đầu kết hợp sấy tạo kiểu theo sở thích.',
      ...
      'spa.services.restore.copy': 'Trải nghiệm gội đầu thư giãn kết hợp massage cổ vai gáy chuyên sâu, giúp giải tỏa căng thẳng và mang lại cảm giác thư thái, dễ chịu.',
      'spa.services.restore.price': 'từ 375.000',
      'spa.services.scalpreset.title': 'Phục hồi da đầu - 90 PHÚT',
      'spa.services.scalpreset.subdesc': 'Scalp Polish · Làm sạch chuyên sâu',
      'spa.services.scalpreset.copy': 'Liệu trình chăm sóc da đầu chuyên sâu, được xây dựng theo tình trạng và nhu cầu riêng của từng người. Kết hợp làm sạch sâu, tẩy tế bào chết và thanh lọc da đầu, giúp da đầu sạch thoáng và cân bằng hơn.',
      'spa.services.scalpreset.price': 'từ 690.000',
      'spa.services.hairreplenish.title': 'Phục hồi tóc - 90 PHÚT',
      'spa.services.hairreplenish.subdesc': 'Hair Treatment · Nuôi dưỡng chuyên sâu',
      'spa.services.hairreplenish.copy': 'Trải nghiệm chăm sóc tóc toàn diện chuyên sâu dành cho mái tóc cần được phục hồi và tái tạo. Liệu trình được thiết kế riêng theo tình trạng tóc, tập trung nuôi dưỡng chuyên sâu, cải thiện độ mềm mượt, độ đàn hồi và vẻ bóng khỏe tự nhiên từ bên trong.',
      ...
      'spa.expect.title': 'Hành trình chăm sóc, từ da đầu đến mái tóc',
      'spa.expect.analyse.title': 'Phân tích',
      'spa.expect.analyse.copy': 'Phân tích tình trạng da đầu và tìm hiểu nhu cầu chăm sóc của bạn.',
      ...
      'spa.expect.treat.title': 'Chăm sóc',
      'spa.expect.treat.copy': 'Massage thư giãn kết hợp chăm sóc chuyên sâu, giúp giải tỏa căng thẳng và chăm sóc da đầu.',
      'spa.expect.nourish.title': 'Nuôi dưỡng',
      'spa.expect.nourish.copy': 'Bổ sung dưỡng chất, giúp mái tóc chắc khỏe, mềm mượt và tràn đầy sức sống.',
      'spa.expect.styling.title': 'Tạo kiểu',
    ...
    zh: {
      ...
      'spa.services.scalpreset.subdesc': '头皮净化 · 深层清洁',
      ...
      'spa.services.hairreplenish.subdesc': '头发修护 · 深层滋养',
