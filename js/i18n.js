...
(function () {
  ...
  var T = {
    ...
    vi: {
      ...
      'about.space.title1': 'Một không gian để bạn chậm lại.',
      'about.space.title2': '',
      'about.space.copy': 'Ánh sáng dịu nhẹ, chất liệu tự nhiên và một không gian được sắp đặt để bạn cảm thấy thoải mái ngay từ khi bước vào.',
