...
(function () {
  ...
  var T = {
    ...
    vi: {
      ...
      'nail.hero.title': "NAEIL'S NAIL",
      'nail.hero.sub': 'Chăm chút cho vẻ đẹp tự nhiên',
      'nail.hero.desc1': 'Sử dụng những sản phẩm được lựa chọn kỹ lưỡng, NAEIL chăm chút đôi tay của bạn với những thiết kế tinh tế, đồng thời đề cao sự khỏe mạnh tự nhiên của móng.',
      'nail.hero.desc2': '',
