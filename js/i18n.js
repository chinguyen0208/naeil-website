...
(function () {
  ...
  var T = {
    en: {
      ...
      'about.hero.desc': 'NAEIL takes its spirit from the quiet beauty of Korean lifestyle culture, where even the smallest ritual is worth doing well.',
      'about.hero.cta': 'Book your appointment',
      'about.philosophy.quote': 'We believe beauty should never feel rushed.',
      'about.philosophy.copy': 'So we built NAEIL around a different pace — one guest, one seat, one ritual at a time. Nothing here is rushed to make room for the next.',
      'about.philosophy.vertical1': 'Thoughtful care.', 'about.philosophy.vertical2': 'In every detail.',
      'about.values.label': 'OUR VALUES',
      'about.values.precision.title': 'Precision', 'about.values.precision.copy': 'From the way we work to the products we choose — nothing is left to chance.',
      'about.values.comfort.title': 'Comfort', 'about.values.comfort.copy': 'A place to settle in fully, without a clock in sight.',
      ...
      'about.ritual.reset.title': 'Reset', 'about.ritual.reset.copy': 'Steady hands, unhurried pace.',
      'about.ritual.restore.title': 'Restore', 'about.ritual.restore.copy': 'Feel lighter, inside out.',
      'about.ritual.leavelighter.title': 'Leave Lighter', 'about.ritual.leavelighter.copy': 'The door closes softly behind you.',
    ...
    vi: {
      ...
      'home.philosophy.copy': 'Tại NAEIL, chúng tôi tin rằng vẻ đẹp đến từ những điều được lựa chọn kỹ lưỡng. Từ sản phẩm lành tính, tiêu chuẩn vệ sinh đến cách mỗi dịch vụ được thực hiện — mọi chi tiết đều hướng đến một trải nghiệm chỉn chu, nhẹ nhàng và dành riêng cho bạn.',
