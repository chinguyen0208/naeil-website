...
(function () {
  ...
  var T = {
    en: {
      ...
      'footer.connect': 'Connect', 'footer.aboutlink2': 'About', 'footer.getintouch': 'Get in Touch',
      'footer.visit': 'Visit',
      'footer.address': '52 Nguyen Thai Hoc, Ba Dinh, Hanoi',
      'footer.phone': '+84 888 104 166', 'footer.hours': 'Open daily, 10am – 8pm',
      'footer.copyright': '© 2026 NAEIL Nail Bar. All rights reserved.',
      // ---- Home ----
      ...
      'home.services.lash.link': 'preview the service',
      ...
      'home.services.spa.link': 'preview the service',
      ...
      'nail.hero.sub1': 'Refined beauty without compromise.',
      'nail.hero.sub2': '',
      ...
      // ---- Coming soon: Lash Lift + Head Spa ----
      'cs.badge': 'Coming soon',
      'cs.btn': 'Coming soon',
      'cs.notice.title': 'A new ritual is coming soon.',
      'cs.notice.lash': 'Lash Lift is being prepared by NAEIL to welcome you.',
      'cs.notice.spa': 'Head Spa is being prepared by NAEIL to welcome you.',
      ...
      'menu.from': 'from',
      'menu.idx.s1': 'Manicure / Pedicure',
      'menu.idx.s2': 'BIAB – Builder Gel',
      'menu.idx.s3': 'Add-on Design',
      'menu.idx.ext': 'Extension',
      'menu.idx.rem': 'Removal',
      'menu.s1.title': 'Manicure / Pedicure',
      'menu.s1.bare.name': 'Bare',
      'menu.s1.bare.desc': 'Cuticle care, shaping and a buffed, natural shine — no colour.',
      'menu.s1.basic.name': 'Basic Gel',
      'menu.s1.basic.desc': 'Cuticle care, shaping and a gel colour finish. Suited to healthy natural nails that need no structuring.',
      'menu.s1.sig.name': 'Signature Strength',
      'menu.s1.sig.desc': 'Cuticle care, shaping, reinforcement and structure for natural nails. Gel colour included.',
      'menu.s1.add.name': 'Adds On',
      'menu.s1.add.desc': 'Upgrade to premium gel colour lines (Cleto, Mayour, The Gel Bottle).',
      'menu.s2.title': 'BIAB – Builder Gel',
      'menu.s2.mani.name': 'Builder Gel Manicure',
      'menu.s2.mani.desc': 'Cuticle care, shaping and a nail structure built with clear BIAB™ by The Gel Bottle. Gel colour not included.',
      'menu.s2.infill.name': 'Builder Gel Infill',
      'menu.s2.infill.desc': 'Cuticle care, shaping, infill of new growth and a rebalanced BIAB™ structure by The Gel Bottle. Gel colour not included.',
      'menu.s2.add.name': 'Adds On',
      'menu.s2.add.desc': 'Add gel colour from our premium lines.',
      'menu.s2.color.name': 'Coloured Builder Gel',
      'menu.s2.color.desc': 'Cuticle care, shaping and a nail structure built with coloured BIAB.',
      'menu.s3.title': 'Add-on Design Menu',
      'menu.s3.cap1': 'playful',
      'menu.s3.cap2': 'new in',
      'menu.s3.cap3': 'curated',
      'menu.s3.art': 'Hand-painted art',
      'menu.s3.blend': 'Nuance nail design',
      'menu.s3.note1': 'Design prices depend on the complexity of the design.',
      'menu.s3.magnet': 'Magnet / Cat-eye',
      'menu.s3.note2': 'Priced per set, depending on the gel line chosen.',
      'menu.s3.chrome': 'Chrome / Mirror',
      'menu.s3.french': 'French',
      'menu.ext.title': 'Extension',
      'menu.ext.tips': 'Soft gel tip extensions',
      'menu.ext.sculpt': 'Sculpted gel extensions',
      'menu.ext.note': 'Priced per set; sculpted gel extension prices vary with length.',
      'menu.rem.title': 'Removal',
      'menu.rem.gel': 'Gel removal',
    ...
    vi: {
      ...
      'footer.copyright': '© 2026 NAEIL Nail Bar. Bảo lưu mọi quyền.',
      'home.hero.title': 'Self care, redefined',
      'home.hero.sub': 'Nơi mỗi trải nghiệm làm đẹp được chăm chút bằng sự tinh tế.',
      ...
      'home.services.lash.link': 'Xem trước dịch vụ',
      'home.services.spa.title': 'Head Spa',
      ...
      'home.services.spa.link': 'Xem trước dịch vụ',
      'home.philosophy.eyebrow': 'ĐIỀU NAEIL THEO ĐUỔI',
      'home.philosophy.title1': 'Đẹp hơn, theo cách của riêng bạn',
      'home.philosophy.title2': '',
      'home.philosophy.title3': '',
      'home.philosophy.copy': 'Tại NAEIL, chúng tôi tin rằng vẻ đẹp đến từ những lựa chọn kỹ lưỡng. Từ sản phẩm lành tính, tiêu chuẩn vệ sinh đến cách mỗi dịch vụ được thực hiện — mọi chi tiết đều hướng đến một trải nghiệm chỉn chu, nhẹ nhàng và dành riêng cho bạn.',
      'home.philosophy.btn': 'Về NAEIL →',
      'nail.hero.title': "NAEIL'S NAIL",
      'nail.hero.sub1': 'Đẹp theo cách tự nhiên nhất.',
      'nail.hero.sub2': '',
      'nail.hero.desc1': 'Sử dụng những sản phẩm được lựa chọn kỹ lưỡng, kết hợp cùng sự chăm chút trong từng bước — để đôi tay đẹp hơn và móng vẫn khỏe mạnh.',
      'nail.hero.desc2': '',
      'nail.hero.cta': 'Đặt lịch dịch vụ',
      'nail.services.eyebrow': 'NHỮNG GÌ NAEIL LỰA CHỌN',
      'nail.services.sub': 'Từ BIAB, gel màu đến các sản phẩm chăm sóc móng, mọi lựa chọn tại NAEIL đều được tuyển chọn kỹ lưỡng, với ưu tiên dành cho chất lượng và sức khỏe tự nhiên của móng.',
      'nail.services.gelbottle.title': 'The Gel Bottle',
      'nail.services.gelbottle.copy': 'Dòng BIAB chuyên nghiệp giúp nuôi dưỡng móng, đồng thời giữ lại vẻ tự nhiên và thanh thoát.',
      'nail.services.mayour.title': 'Mayour',
      ...
      'about.philosophy.quote': 'Từ những điều nhỏ nhất.',
      'about.philosophy.copy': 'Mỗi trải nghiệm tại NAEIL là một khoảng dừng, nơi kỹ thuật, sản phẩm và sự chăm sóc đều được cân nhắc kỹ lưỡng đến từng chi tiết.',
      ...
      'about.space.label': 'VỀ KHÔNG GIAN',
      'about.space.title1': 'Một không gian để',
      'about.space.title2': 'bạn chậm lại.',
      'about.space.copy': 'Ánh sáng dịu nhẹ, chất liệu tự nhiên và mọi thứ được sắp đặt để bạn cảm thấy thoải mái.',
      ...
      'cs.btn': 'Coming soon',
      'cs.notice.title': 'A new ritual is coming soon.',
      'cs.notice.lash': 'Lash Lift đang được NAEIL chuẩn bị để đón bạn.',
      'cs.notice.spa': 'Head Spa đang được NAEIL chuẩn bị để đón bạn.',
      ...
      'menu.s1.title': 'Manicure / Pedicure',
      'menu.s1.bare.name': 'Bare',
      'menu.s1.bare.desc': 'Xử lý da, dũa form, làm bóng bề mặt móng tự nhiên không sơn màu.',
      'menu.s1.basic.name': 'Basic Gel',
      'menu.s1.basic.desc': 'Chăm sóc da, dũa form và hoàn thiện với màu gel. Phù hợp với nền móng khỏe k cần định hình.',
      'menu.s1.sig.name': 'Signature Strength',
      'menu.s1.sig.desc': 'Xử lý da, dũa form, gia cố và tạo cấu cho móng tự nhiên. Bao gồm sơn màu gel.',
      'menu.s1.add.name': 'Adds On',
      'menu.s1.add.desc': 'Nâng cấp với các dòng màu gel cao cấp (Cleto, Mayour, The Gel Bottle).',
      'menu.s2.title': 'BIAB – Builder Gel',
      'menu.s2.mani.name': 'Builder Gel Manicure',
      'menu.s2.mani.desc': 'Xử lý da, dũa form, tạo cấu trúc móng bằng BIAB™ không màu từ The Gel Bottle. Không bao gồm sơn màu gel.',
      'menu.s2.infill.name': 'Builder Gel Infill',
      'menu.s2.infill.desc': 'Xử lý da, dũa form, dặm phần móng mọc mới và cân chỉnh lại cấu trúc BIAB™ từ The Gel Bottle. Không bao gồm sơn màu gel.',
      'menu.s2.add.name': 'Adds On',
      'menu.s2.add.desc': 'Thêm sơn gel từ các dòng sơn cao cấp.',
      'menu.s2.color.name': 'Builder Gel có màu',
      'menu.s2.color.desc': 'Xử lý da, dũa form và tạo cấu trúc móng bằng BIAB có màu.',
      'menu.s3.title': 'Add-on Design Menu',
      'menu.s3.cap1': 'playful',
      'menu.s3.cap2': 'new in',
      'menu.s3.cap3': 'curated',
      'menu.s3.art': 'Vẽ trang trí',
      'menu.s3.blend': 'Loang',
      'menu.s3.note1': 'Giá dịch vụ trang trí được tính dựa trên độ phức tạp của design.',
      'menu.s3.magnet': 'Magnet / Mắt mèo',
      'menu.s3.note2': 'Giá áp dụng theo bộ, tùy thuộc vào dòng sơn lựa chọn.',
      'menu.s3.chrome': 'Chrome / Tráng gương',
      'menu.s3.french': 'French',
      'menu.ext.title': 'Extension',
      'menu.ext.tips': 'Nối móng úp',
      'menu.ext.sculpt': 'Nối móng đắp gel',
      'menu.ext.note': 'Đơn giá áp dụng cho một bộ, giá dịch vụ nối móng đắp gel thay đổi dựa trên độ dài.',
      'menu.rem.title': 'Removal',
      'menu.rem.gel': 'Tháo gel',
    ...
    zh: {
      ...
      'footer.headspa': '头皮护理',
      'footer.connect': '联系', 'footer.aboutlink2': '关于我们', 'footer.getintouch': '联系我们',
      'footer.visit': '到店信息',
      'footer.address': '河内市巴亭郡阮太学街52号',
      'footer.phone': '+84 888 104 166', 'footer.hours': '每日营业 上午10点至晚上8点',
      'footer.copyright': '© 2026 NAEIL Nail Bar. 保留所有权利。',
      ...
      'cs.btn': 'Coming soon',
      'cs.notice.title': 'A new ritual is coming soon.',
      'cs.notice.lash': 'NAEIL 正在精心筹备睫毛烫服务，敬请期待。',
      'cs.notice.spa': 'NAEIL 正在精心筹备头皮护理服务，敬请期待。',
      ...
      'menu.from': '起',
      'menu.idx.s1': '手足护理',
      'menu.idx.s2': 'BIAB 建构凝胶',
      'menu.idx.s3': '装饰设计',
      'menu.idx.ext': '延长甲',
      'menu.idx.rem': '卸甲',
      'menu.s1.title': '手足护理 Manicure / Pedicure',
      'menu.s1.bare.name': 'Bare 自然护理',
      'menu.s1.bare.desc': '死皮处理、修形，抛光自然甲面，不上色。',
      'menu.s1.basic.name': 'Basic Gel 基础凝胶',
      'menu.s1.basic.desc': '死皮护理、修形，并以凝胶色完成。适合健康、无需塑形的自然甲。',
      'menu.s1.sig.name': 'Signature Strength 招牌强韧',
      'menu.s1.sig.desc': '死皮处理、修形，为自然甲加固并塑造结构。含凝胶上色。',
      'menu.s1.add.name': 'Adds On 加购',
      'menu.s1.add.desc': '升级为高端凝胶色系（Cleto、Mayour、The Gel Bottle）。',
      'menu.s2.title': 'BIAB – Builder Gel 建构凝胶',
      'menu.s2.mani.name': 'Builder Gel Manicure 建构凝胶护理',
      'menu.s2.mani.desc': '死皮处理、修形，以 The Gel Bottle 透明 BIAB™ 塑造甲型结构。不含凝胶上色。',
      'menu.s2.infill.name': 'Builder Gel Infill 建构凝胶补甲',
      'menu.s2.infill.desc': '死皮处理、修形，补填新生甲并重新调整 The Gel Bottle BIAB™ 结构。不含凝胶上色。',
      'menu.s2.add.name': 'Adds On 加购',
      'menu.s2.add.desc': '添加高端系列凝胶色。',
      'menu.s2.color.name': 'Builder Gel 彩色建构凝胶',
      'menu.s2.color.desc': '死皮处理、修形，以彩色 BIAB 塑造甲型结构。',
      'menu.s3.title': '装饰设计 Add-on Design',
      'menu.s3.cap1': 'playful',
      'menu.s3.cap2': 'new in',
      'menu.s3.cap3': 'curated',
      'menu.s3.art': '手绘装饰',
      'menu.s3.blend': 'Nuance 氛围感美甲',
      'menu.s3.note1': '装饰价格依设计的复杂程度而定。',
      'menu.s3.magnet': '磁吸 / 猫眼',
      'menu.s3.note2': '按整套计价，视所选色系而定。',
      'menu.s3.chrome': 'Chrome 镜面',
      'menu.s3.french': '法式 French',
      'menu.ext.title': 'Extension 延长甲',
      'menu.ext.tips': '甲片延长',
      'menu.ext.sculpt': '光疗雕塑延长',
      'menu.ext.note': '按整套计价；光疗雕塑延长价格依长度而定。',
      'menu.rem.title': 'Removal 卸甲',
      'menu.rem.gel': '卸凝胶',
