...
(function () {
  ...
  var T = {
    en: {
      ...
      'menu.s2.mani.desc': 'Cuticle care, shaping and a nail structure built with clear BIAB™ by The GelBottle. Gel colour not included.',
      'menu.s2.infill.name': 'Builder Gel Infill',
      'menu.s2.infill.desc': 'Cuticle care, shaping, infill of new growth and a rebalanced BIAB™ structure by The GelBottle. Gel colour not included.',
    ...
    vi: {
      ...
      'menu.s2.title': 'BIAB – Builder Gel',
      'menu.s2.mani.name': 'Builder Gel Manicure',
      'menu.s2.mani.desc': 'Xử lý da, dũa form, tạo cấu trúc móng bằng BIAB™ không màu từ The GelBottle. Không bao gồm sơn màu gel.',
      'menu.s2.infill.name': 'Builder Gel Infill',
      'menu.s2.infill.desc': 'Xử lý da, dũa form, dặm phần móng mọc mới và cân chỉnh lại cấu trúc BIAB™ từ The GelBottle. Không bao gồm sơn màu gel.',
      'menu.s2.add.name': 'Adds On',
      ...
      'menu.ext.note': 'Đơn áp dụng cho một bộ, giá dịch vụ nối móng đắp gel thay đổi dựa trên độ dài.',
      'menu.rem.title': 'Removal',
    ...
    zh: {
      ...
      'menu.s2.mani.desc': '死皮处理、修形，以 The GelBottle 透明 BIAB™ 塑造甲型结构。不含凝胶上色。',
      'menu.s2.infill.name': 'Builder Gel Infill 建构凝胶补甲',
      'menu.s2.infill.desc': '死皮处理、修形，补填新生甲并重新调整 The GelBottle BIAB™ 结构。不含凝胶上色。',
