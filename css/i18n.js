...
(function () {
  ...
  var T = {
    ...
    vi: {
      ...
      'nail.services.sub': 'Từ gel, sơn màu đến các sản phẩm chăm sóc móng, mỗi sản phẩm tại NAEIL đều được lựa chọn kỹ lưỡng, với ưu tiên dành cho chất lượng và sức khỏe tự nhiên của móng.',
      'nail.services.gelbottle.title': 'The Gel Bottle',
      'nail.services.gelbottle.copy': 'Dòng BIAB chuyên nghiệp với công thức lành tính, dành cho một nền móng khỏe và bền đẹp.',
      'nail.services.mayour.title': 'Mayour',
      'nail.services.mayour.copy': 'Màu gel Hàn Quốc cao cấp với bảng màu tinh tế, độ bền đẹp và công thức được lựa chọn để nâng niu móng tự nhiên.',
      'nail.services.favori.title': 'Favori',
