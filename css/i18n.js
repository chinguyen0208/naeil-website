...
(function () {
  ...
  var T = {
    ...
    vi: {
      ...
      'home.hero.title': 'Self care, redefined',
      'home.hero.sub': 'Nơi mỗi trải nghiệm làm đẹp được chăm chút bằng sự tinh tế.',      'home.hero.cta': 'Đặt lịch trải nghiệm',
      ...
      'home.philosophy.copy': 'Tại NAEIL, chúng tôi tin rằng vẻ đẹp đến từ những lựa chọn kỹ lưỡng. Từ sản phẩm lành tính, tiêu chuẩn vệ sinh đến cách mỗi dịch vụ được thực hiện — mọi chi tiết đều hướng đến một trải nghiệm chỉn chu, nhẹ nhàng và dành riêng cho bạn.',      'home.philosophy.btn': 'Về NAEIL →',
      'nail.hero.title': "NAEIL'S NAIL",
